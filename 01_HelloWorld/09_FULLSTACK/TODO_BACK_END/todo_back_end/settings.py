...
SECRET_KEY = '^6glkz!5p^fvqdcn-w6jducz%q-rr6p^#1thhm!h$95f_j7brh'
...
MIDDLEWARE = [
    # middleware : 모든 middleware는 req가 있으면 res가 있어야 하는 cycle을 가진다.
    # 모든 요청은 위에서부터 아래로 모두 통과해야 함. 하나라도 막히면 안 됨
...
#     "http://127.0.0.1:8080",  # 이를 허락 하겠다.
# ]

CORS_ORIGIN_ALLOW_ALL = True  # 우선은 모두 all
...
$ netstat -ano | findstr :8000
  TCP    127.0.0.1:8000         0.0.0.0:0              LISTENING       2328
"""